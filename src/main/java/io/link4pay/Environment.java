...
public class Environment {
    ...
    public static final Environment QA = new Environment("https://gateway.qa.link4paypayments.com:443", "https://auth.qa.venmo.com", new String[]{"ssl/api_link4pay_com.ca.crt", "ssl/payments_link4Payapi_com.ca.crt"}, "qa");

    /** For production. */
    public static final Environment PRODUCTION = new Environment("https://api.link4pay.com:443", "https://auth.venmo.com", new String[]{"ssl/api_link4pay_com.ca.crt", "ssl/payments_link4Payapi_com.ca.crt"}, "production");

    /** For merchants to use during their development and testing. */
    public static final Environment SANDBOX = new Environment("https://api.sandbox.link4pay.com:443", "https://auth.sandbox.venmo.com", new String[]{"ssl/api_link4pay_com.ca.crt", "ssl/payments_link4Payapi_com.ca.crt"}, "sandbox");
